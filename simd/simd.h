...
#define MR_ADD64S(X,Y) _mm_add_epi64(X,Y)
...
#define MR_ADD64S(X,Y) _mm256_add_epi64(X,Y)
...
#define MR_MULADDU(T,X,Y) ({spint PP=_mm256_mul_epu32(X,Y); _mm256_add_epi64(T,PP);})
#define MR_MULADDS(T,X,Y) {spint PP=_mm256_mul_epi32(X,Y); _mm256_add_epi64(T,PP);}
#define MR_MUL64_CONSTANT(X,C) ({spint S=MR_SET_ALL_LANES_TO_CONSTANT(C); spint PP1=_mm256_mul_epu32(X,S); spint PP2=_mm256_mul_epu32(_mm256_srli_epi64(X,32),S); _mm256_add_epi64(PP1,_mm256_slli_epi64(PP2,32));})
#define MR_MUL32_CONSTANT(X,C) ({spint S=MR_SET_ALL_LANES_TO_CONSTANT(C); _mm256_mul_epu32(X,S);})
#define MR_MULADD32_CONSTANT(T,X,C) ({spint S=MR_SET_ALL_LANES_TO_CONSTANT(C); _mm256_add_epi64(T,_mm256_mul_epu32(X,S));})
#define MR_MUL32U(X,Y) _mm256_mul_epu32(X,Y)
#define MR_MUL32S(X,Y) _mm256_mul_epi32(X,Y)
...
#define MR_SUB64S(X,Y) _mm256_sub_epi64(X,Y)
...
#define MR_ADD64S(X,Y) _mm512_add_epi64(X,Y)
...
#define MR_MULADDU(T,X,Y) ({spint PP=_mm512_mul_epu32(X,Y); _mm512_add_epi64(T,PP);})
#define MR_MULADDS(T,X,Y) {spint PP=_mm512_mul_epi32(X,Y); _mm512_add_epi64(T,PP);}
#define MR_MUL64_CONSTANT(X,C) ({spint S=MR_SET_ALL_LANES_TO_CONSTANT(C); spint PP1=_mm512_mul_epu32(X,S); spint PP2=_mm512_mul_epu32(_mm512_srli_epi64(X,32),S); _mm512_add_epi64(PP1,_mm512_slli_epi64(PP2,32));})
#define MR_MUL32_CONSTANT(X,C) ({spint S=MR_SET_ALL_LANES_TO_CONSTANT(C); _mm512_mul_epu32(X,S);})
#define MR_MULADD32_CONSTANT(T,X,C) ({spint S=MR_SET_ALL_LANES_TO_CONSTANT(C); _mm512_add_epi64(T,_mm512_mul_epu32(X,S));})
#define MR_MUL32U(X,Y) _mm512_mul_epu32(X,Y)
#define MR_MUL32S(X,Y) _mm512_mul_epi32(X,Y)
...
#define MR_SUB64S(X,Y) _mm512_sub_epi64(X,Y)
...
#define MR_ADD64S(X,Y) vaddq_s64(X,Y)
...
#define MR_MUL64_CONSTANT(X,C) ({udpint PP1=vmull_n_u32(vmovn_u64(X),C); udpint PP2=vmull_n_u32(vmovn_u64(vshrq_n_u64(X,32)),C);vaddq_u64(PP1,vshlq_n_u64(PP2,32));})
