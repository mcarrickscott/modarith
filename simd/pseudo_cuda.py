# Python program to generate reasonably efficient C/C++ modular arithmetic code for pseudo-mersenne primes using Nvidia CUDA GPUs
...
if len(sys.argv)!=2 :
    print("Syntax error")
    print("Valid syntax - python pseudo_cuda.py <prime> OR <prime name>")
    print("For example - python pseudo_cuda.py X25519")
    print("For example - python pseudo_cuda .py 2**255-19")
    exit(2)
