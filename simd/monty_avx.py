...
def intrinsics() :
    ...
    str+="// t+=a*b where t is 64 bits, a and b 32 bits\n"
    str+="static inline __m256i _mm256_mla_epi32(__m256i t,__m256i a,__m256i b) {\n"
    str+="\t__m256i pp=_mm256_mul_epi32(a,b);\n"
    str+="\treturn _mm256_add_epi64(t,pp);\n" 
    str+="}\n" 
...
def modmli(n) :
    ...
    if trin>0 :
        ...
        for i in range(0,N) :
            str+="\tt=_mm256_mlca_epu32(t,a[{}],b); ".format(i)
...
#        str+="/*\n"
        ...
        str+="\tt=_mm256_mlca_epu32(t,a[{}],b); ".format(N-1)
        str+="c[{}]=(spint)t;\n".format(N-1)
