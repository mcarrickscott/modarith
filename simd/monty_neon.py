# Python program to generate reasonably efficient C/C++ modular arithmetic code for any prime using ARM NEON SIMD extensions
...
#
# How to use. 
# (1) First execute this program: python3 monty_neon.py NIST256. Output code is written to file field.c or group.c
