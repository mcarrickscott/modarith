...
/*
int ecnXXXgetxyz(point *P,char *x,char *y,char *z)
{
    spint X[Nlimbs],Y[Nlimbs];
    modexp(P->x,x);
    modexp(P->y,y);
...
static void select(int b,point W[],point *P)
{
    ...
    ecnXXXcmv(teq(babs, 1),&W[1],P); // conditional move
    ecnXXXcmv(teq(babs, 2),&W[2],P); // conditional move
    ecnXXXcmv(teq(babs, 3),&W[3],P); // conditional move
    ecnXXXcmv(teq(babs, 4),&W[4],P); // conditional move
    ecnXXXcmv(teq(babs, 5),&W[5],P); // conditional move
    ecnXXXcmv(teq(babs, 6),&W[6],P); // conditional move
    ecnXXXcmv(teq(babs, 7),&W[7],P); // conditional move
    ecnXXXcmv(teq(babs, 8),&W[8],P); // conditional move
